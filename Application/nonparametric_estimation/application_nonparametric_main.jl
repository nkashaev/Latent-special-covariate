...
dir=rootdir*"/Application/nonparametric_estimation/"
dirresults=dir*"results/"
dirdata=rootdir*"/Application/data/"

## Functions
include(dir*"/nonparametric_functions.jl")
...
CSV.write(dirresults*"estimates_and_se.csv", DataFrame(Results, :auto), header=false)
